...
class PerceptionNode(Node):
    def __init__(self):
        ...
        # --- 4. Subscribers ---
        self.create_subscription(Image, '/camera/image', self.rgb_callback, qos_policy)
        self.create_subscription(CameraInfo, '/camera/camera_info', lambda msg: None, qos_policy)
        self.create_subscription(Image, '/camera/depth_image', self.depth_callback, qos_policy)
